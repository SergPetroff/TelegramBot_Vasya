...
const showExchangeTCS =  async ()=>{
    ...
    if(dataExc){
       ...
       <b>USD</b> я покупаю: <b>${dataExc.usdrub.sell}</b>,  я продаю: <b>${dataExc.usdrub.buy}</b>, спред: <b>${dataExc.usdrub.spread?dataExc.usdrub.spread:"н/д"}%</b>
       <b>EUR</b> я покупаю: <b>${dataExc.eurrub.sell}</b>,  я продаю: <b>${dataExc.eurrub.buy}</b>, спред: <b>${dataExc.eurrub.spread?dataExc.eurrub.spread:"н/д"}%</b>
       <b>GBP</b> я покупаю: <b>${dataExc.gbprub.sell}</b>,  я продаю: <b>${dataExc.gbprub.buy}</b>, спред: <b>${dataExc.gbprub.spread?dataExc.gbprub.spread:"н/д"}%</b>
       `
    }else{
